...
export default function LinktreeProfile() {
  const [activeTab, setActiveTab] = useState<'links' | 'sobre'>('links')
  return (
    <div className="min-h-screen" style={{ background: "#090B0F" }}>
      <div className="max-w-sm mx-auto px-6 py-8">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex">
            <button
              ...
              className={`text-sm px-4 py-1 border-b-2 transition-colors ${
                activeTab === 'links' ? 'border-[#FFFBD7] text-[#FFFBD7]' : 'border-transparent text-[#FFFBD7]/70 hover:text-[#FFFBD7]'
              }`}
            >
              Links Úteis
            </button>
            <button
              ...
              className={`text-sm px-4 py-1 ml-6 border-b-2 transition-colors ${
                activeTab === 'sobre' ? 'border-[#FFFBD7] text-[#FFFBD7]' : 'border-transparent text-[#FFFBD7]/70 hover:text-[#FFFBD7]'
              }`}
            >
              Sobre
            </button>
        ...
        {activeTab === 'links' && (
          <>
            ...
            <div className="space-y-3 mb-8">
              ...
              <Link href="https://www.facebook.com/share/1AuufW4tkE/" className="block">
                <div className="bg-[#1A212B] backdrop-blur-sm rounded-2xl p-4 flex items-center justify-between hover:bg-[#232A34] transition-all duration-300 border border-slate-500/30 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  <div className="flex items-center gap-4">
                    <div className="bg-[#161F24] p-3 rounded-full border-2 border-[#CEA886] flex items-center justify-center shadow-inner">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="#CEA886">
                    ...
                    <div>
                      <div className="text-base font-normal" style={{ color: "#CEA886" }}>Facebook</div>
                    </div>
                  </div>
                  <div style={{ color: "#B80618" }}>
                    <svg width="12" height="20" viewBox="0 0 12 20" fill="currentColor">
              ...
              <Link href="https://www.linkedin.com/in/lucimeire-xavier/" className="block">
                <div className="bg-[#1A212B] backdrop-blur-sm rounded-2xl p-4 flex items-center justify-between hover:bg-[#232A34] transition-all duration-300 border border-slate-500/30 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  <div className="flex items-center gap-4">
                    <div className="bg-[#161F24] p-3 rounded-full border-2 border-[#CEA886] flex items-center justify-center shadow-inner">
        ...
        {activeTab === 'sobre' && (
          <div className="mb-8">
            <h2 className="text-lg font-semibold mb-3" style={{ color: "#FFFBD7" }}>
              Sobre a Lucimeire Xavier Advocacia – Sua parceira estratégica em Direito Tributário
            </h2>
            <div className="space-y-3 text-sm leading-relaxed" style={{ color: "#FFFBD7" }}>
              <p>
                A Lucimeire Xavier Advocacia é um escritório jurídico especializado em Direito Tributário,
                criado para oferecer soluções inteligentes e seguras a empresas e profissionais que buscam
                reduzir impostos de forma legal, recuperar tributos pagos indevidamente e resolver pendências
                fiscais com agilidade e segurança jurídica. Atuamos tanto no contencioso tributário (disputas
                judiciais e administrativas) quanto na esfera preventiva e consultiva, sempre com foco em gerar
              ...
              <p>
                Seja para planejamento tributário, defesa em execuções fiscais, recuperação de créditos
                tributários ou otimização de cargas fiscais, a Lucimeire Xavier Advocacia se posiciona como um
                parceiro confiável e proativo para garantir que sua empresa esteja sempre em conformidade e
                pague apenas o que é devido.
              </p>
              <p>
                💬 Quer saber como podemos ajudar seu negócio a economizar e se proteger de riscos fiscais?
                <br />
                ➡️ Fale agora com a Dra. Lucimeire Xavier pelo WhatsApp.
              </p>
            </div>
            <div className="mt-5">
              <Link href="https://api.whatsapp.com/send/?phone=551111967586911&text&type=phone_number&app_absent=0" className="inline-block">
                <span className="px-4 py-2 rounded-lg text-sm font-medium border border-[#CEA886] text-[#CEA886] hover:bg-[#CEA886]/10 transition-colors">
                  Falar no WhatsApp
                </span>
              </Link>
            </div>
